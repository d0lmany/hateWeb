...
<body class="text-slate-50 bg-slate-900 accent-pink-500">
    ...
    <main class="m-10 flex justify-center">
        ...
        exit();
                ...
                show_categories();
                $qwe = "</select></label><label class='flex justify-between mb-1'>Цена:<input type='number' name='price' class='bg-slate-900 border border-slate-150 w-1/2' value=".$ware[3]."></label>
                ...
                <input type='hidden' name='id' value=$ware[0]><input type='submit' value='Сохранить' class='bg-violet-950 p-2 text-center hover:bg-violet-900 transition duration-150 w-full'>"; echo $qwe;
            } else {
                $qwe = <<<LIT
                <form method="post" class="p-2 border border-slate-150 bg-indigo-950">
